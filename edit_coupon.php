...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($coupon_code) || empty($start_date) || empty($valid_until)) {
        ...
        $stmt->bind_param("isssdissiii", $category_id, $title, $coupon_code, $description, $discount_percentage, $is_approved, $start_date, $valid_until, $subcategory_id, $coupon_id, $vid);
